...
'set clevs 'colndx
'set ccols 'colevs
if (hh=06);'d prec(t='it0')';endif
if (hh=12);'d (prec(t='it0')-prec(t='it1'))';endif
if (hh=18);'d (prec(t='it0')-prec(t='it1'))';endif
if (hh=24);'d (prec(t='it0')-prec(t='it1'))';endif
if (hh=30);'d (prec(t='it0')-prec(t='it1'))';endif
if (hh=36);'d (prec(t='it0')-prec(t='it1'))';endif
if (hh=42);'d (prec(t='it0')-prec(t='it1'))';endif
if (hh=48);'d (prec(t='it0')-prec(t='it1'))';endif
'draw shp alg.shp'
'run cbarn.gs'
'set strsiz .17'
'set string 1 l 6'
'draw string 0.8 10.8 '  ' Cumuls Pluies en 06h (mm)'
'set strsiz .17'
'set string 1 l 6'
...
'gxprint ../AROME/tmp/work/surface/rr06h_'ii'.png png x800 y800 white'
  'reset'
****************************************************************
******
*  PLOT CUMUL de neige 6H 
******
*-----------
'set t 'it0
*-----------
...
'set clevs 'colndx
'set ccols 'colevs
if (hh=06);'d neig(t='it0')';endif
if (hh=12);'d (neig(t='it0')-neig(t='it1'))';endif
if (hh=18);'d (neig(t='it0')-neig(t='it1'))';endif
if (hh=24);'d (neig(t='it0')-neig(t='it1'))';endif
if (hh=30);'d (neig(t='it0')-neig(t='it1'))';endif
if (hh=36);'d (neig(t='it0')-neig(t='it1'))';endif
if (hh=42);'d (neig(t='it0')-neig(t='it1'))';endif
if (hh=48);'d (neig(t='it0')-neig(t='it1'))';endif
'draw shp alg.shp'
'run cbarn.gs'
'set strsiz .17'
'set string 1 l 6'
'draw string 0.8 10.8 '  ' Ep Neige en 6h '
'set strsiz .17'
'set string 1 l 6'
'draw string 1.5 10.4 ' '(ech ' chh 'h)'
'set strsiz .16'
...
'set display color white'
'gxprint ../AROME/tmp/work/surface/nn06h_'ii'.png png x800 y800 white'
  'reset'
 ii=ii+1
it0 = it0 + 2
endwhile
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'set display color white'
'gxprint ../AROME/tmp/work/surface/rr12h_'ii'.png png x800 y800 white'
  'reset'
****************************************************************
******
*  PLOT CUMUL NEIGE 12H 
******
*-----------
'set t 'it0
*-----------
...
'draw string 3.5 0.7 ' 'Arome/Algerie (en cm)'
'set display color white'
'gxprint ../AROME/tmp/work/surface/nn12h_'ii'.png png x800 y800 white'
'reset'
*-----------
ii=ii+1
it0 = it0 + 4
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'set display color white'
'gxprint ../AROME/tmp/work/surface/rr24h_'ii'.png png x800 y800 white'
  'reset'
****************************************************************
******
*  PLOT CUMUL NEIGE 24H 
******
*-----------
'set t 'it0
*-----------
...
'draw string 3.5 0.7 ' 'Arome/Algerie (en cm)'
'set display color white'
'gxprint ../AROME/tmp/work/surface/nn24h_'ii'.png png x800 y800 white'
  'reset'
*-----------
ii=ii+1
it0 = it0 + 8
