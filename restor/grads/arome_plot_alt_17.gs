...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/tetaw'level'_'it0'.png png x800 y800 white'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/vv'level'_'it0'.png png x800 y800 white'
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
*'run cbarn.gs'
'gxprint ../AROME/tmp/work/altitude/zv'level'_'it0'.png png x800 y800 white'
...
'draw string 3.5 0.7 ' 'Arome/Algerie (---)'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/icecr'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT SNOW
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie (---)'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/snow'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT RAIN
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie (---)'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/rain'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT GRAUPEL
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie (---)'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/grpl'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT TKE
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/altitude/tke'level'_'it0'.png png x800 y800 white'
****************************************************************
******
...
'set ccols 0 77 78 79 80 81 82 83 84 85 86 87 89 90 91 92 93 94 95 96 97 98 99 101 102'
'd tpot-273'
'set strsiz .15'
'set string 1 l 6'
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/tpot'level'_'it0'.png png x800 y800 white'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/vvel'level'_'it0'.png png x800 y800 white'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/potvor'level'_'it0'.png png x800 y800 white'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/absvor'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT DIVERGENCE
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/tmp/work/derive/div'level'_'it0'.png png x800 y800 white'
*******************************************************************************************
*******************************************************************************************
'reset'
it0 = it0 + 1
