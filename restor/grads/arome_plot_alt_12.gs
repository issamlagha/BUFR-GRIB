...
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/zt'level'_'it0'.png png x800 y800 white'
****************************************************************
****************************************************************
******
*  PLOT TETHA PRIM W
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/tetaw'level'_'it0'.png png x800 y800 white'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/vv'level'_'it0'.png png x800 y800 white'
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
*'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/zv'level'_'it0'.png png x800 y800 white'
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/rh'level'_'it0'.png png x800 y800 white'
...
'set strsiz .15'
'set string 1 l 6'
'draw string 0.5 10.8 ' level ' Cloud Water (*1e4)'
'set strsiz .17'
'set string 1 l 6'
'draw string 1.5 10.4 ' '(ech ' chh 'h)'
'set strsiz .16'
...
'draw string 3.5 0.7 ' 'Arome/Algerie (---)'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/clwat'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT CLOUD FRACTION
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/clfra'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT ICE CRYSTAL
******
...
'set strsiz .15'
'set string 1 l 6'
'draw string 0.5 10.8 ' level ' Ice Crystal (*1e5)'
'set strsiz .17'
'set string 1 l 6'
'draw string 1.5 10.4 ' '(ech ' chh 'h)'
'set strsiz .16'
...
'draw string 3.5 0.7 ' 'Arome/Algerie (---)'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/icecr'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT SNOW
******
...
'set strsiz .15'
'set string 1 l 6'
'draw string 0.5 10.8 ' level ' SNOW (*1e5)'
'set strsiz .17'
'set string 1 l 6'
'draw string 1.5 10.4 ' '(ech ' chh 'h)'
'set strsiz .16'
...
'draw string 3.5 0.7 ' 'Arome/Algerie (---)'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/snow'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT RAIN
******
...
'set strsiz .15'
'set string 1 l 6'
'draw string 0.5 10.8 ' level ' RAIN (*1e5)'
'set strsiz .17'
'set string 1 l 6'
'draw string 1.5 10.4 ' '(ech ' chh 'h)'
'set strsiz .16'
...
'draw string 3.5 0.7 ' 'Arome/Algerie (---)'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/rain'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT GRAUPEL
******
...
'set strsiz .15'
'set string 1 l 6'
'draw string 0.5 10.8 ' level ' GRAUPEL (*1e4)'
'set strsiz .17'
'set string 1 l 6'
'draw string 1.5 10.4 ' '(ech ' chh 'h)'
'set strsiz .16'
...
'draw string 3.5 0.7 ' 'Arome/Algerie (---)'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/grpl'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT TKE
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/tke'level'_'it0'.png png x800 y800 white'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/tpot'level'_'it0'.png png x800 y800 white'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/vvel'level'_'it0'.png png x800 y800 white'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/potvor'level'_'it0'.png png x800 y800 white'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/absvor'level'_'it0'.png png x800 y800 white'
****************************************************************
******
*  PLOT DIVERGENCE
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'run cbarn.gs'
'gxprint ../AROME/gifs/altitude/div'level'_'it0'.png png x800 y800 white'
*******************************************************************************************
*******************************************************************************************
'reset'
it0 = it0 + 1
