...
'gxprint ../AROME/gifs/surface/rr06h_'ii'.png png x800 y800 white'
  'reset'
****************************************************************
******
...
'set display color white'
'gxprint ../AROME/gifs/surface/nn06h_'ii'.png png x800 y800 white'
  'reset'
 ii=ii+1
it0 = it0 + 2
endwhile
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'set display color white'
'gxprint ../AROME/gifs/surface/rr12h_'ii'.png png x800 y800 white'
  'reset'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie (en cm)'
'set display color white'
'gxprint ../AROME/gifs/surface/nn12h_'ii'.png png x800 y800 white'
'reset'
*-----------
ii=ii+1
it0 = it0 + 4
...
'draw string 3.5 0.7 ' 'Arome/Algerie'
'set display color white'
'gxprint ../AROME/gifs/surface/rr24h_'ii'.png png x800 y800 white'
  'reset'
****************************************************************
******
...
'draw string 3.5 0.7 ' 'Arome/Algerie (en cm)'
'set display color white'
'gxprint ../AROME/gifs/surface/nn24h_'ii'.png png x800 y800 white'
  'reset'
*-----------
ii=ii+1
it0 = it0 + 8
