       program fullpos
       parameter (KNI=122500,WIDF=KNI,IM=350,JM=350,LMAX=8)  
        parameter (IECMAX=17,IPMAX=7)
	 ...
	 CHARACTER (LEN=259):: FMT1
         ...
         INTEGER  N, I, J
        data (ent(i),i=1,IPMAX) /'H','T','UU','VV','RH','WW','THETA'/ 

        data (len(i),i=1,IPMAX) /1,1,2,2,2,2,5/
        open(1,
     &  file='../../SORTIE/ALADIN_ALT.dat',
