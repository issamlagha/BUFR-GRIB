#!/bin/bash
#-------------------------------------------------------------------------------------------------------------------------------------
#    Objectif  :  Téléchargement des données du modèle ALADIN à partir du HPC (ONM). 
...
#-------------------------------------------------------------------------------------------------------------------------------------
echo "*******************************************************************************************************************************"
echo "*  >  Téléchargement des données ALADIN  :                                                                                    *"
echo "*                                                                                                                             *"
...
sshpass -p "password" scp -r hpc@adress:/fennecData/data/chprod/ALADIN/FULLPOS/$AA/$MM/$JJ/r${rr}/FULLPOS_${AA}${MM}${JJ}${rr}_${i}  .
done
#-------------------------------------------------------------------------------------------------------------------------------------
