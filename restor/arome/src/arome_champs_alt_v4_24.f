       program fullpos
       parameter (KNI=160000,WIDF=KNI,IM=400,JM=400,LMAX=4)  
        parameter (IECMAX=9,IPMAX=18)
	 ...
	 CHARACTER (LEN=259):: FMT1
         ...
         INTEGER  N, I, J
        data (ent(i),i=1,IPMAX) /'T','RH','UU','VV','cld_wat',
     &    'cld_fra','ice_cry','snow','rain','graupel','tke',
     &    'temp_pot','THETA','vert_vel','pot_vort','vvert',
     &    'abs_vort','div'/ 

        data (len(i),i=1,IPMAX) /1,2,2,2,7,7,7,4,4,7,3,8,5,8,8,5,
     &                       8,3/
        open(1,
     &  file='../../SORTIE/AROME_ALT.dat',
