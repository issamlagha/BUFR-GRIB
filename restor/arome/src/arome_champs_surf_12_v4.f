     ...
     &    'neb_bas','neb_tot','neb_conv','mslp','wat_vap','cape'/ 
        ...
        data (len(i),i=1,17) /3,4,4,4,7,7,9,4,4,7,7,7,7,8,4,7,4/
        open(1,
     &   file='/oper/home/ch1/CLIENT/SITE120/SORTIE/AROME_SURF_12.dat',
...
!==================== lecture des donn�es entr�e=============
        OPEN(UNIT=11,
     &  FILE='/oper/home/ch1/CLIENT/data/output/arome/'//file1)
