	 ...
	 CHARACTER (LEN=259):: FMT1
         ...
         INTEGER  N, I, J
        data (ent(i),i=1,IPMAX) /'acpluie','acneige','acgraupel'/ 

        data (len(i),i=1,IPMAX) /7,7,9/
        open(1,
     &  file='/home/cnpm/Aladin/sortie/AROME_SURF.dat',
...
!==================== lecture des donn�es entr�e=============
	OPEN(UNIT=11,
     &  FILE='/home/cnpm/Aladin/work/'//file1)
