...
input_dir="/home/pnt/work/output/composites"
output_dir="/home/pnt/work/output/reprojected_composites"

mkdir -p "$output_dir"

# Process only TIFF files under the ir_105 subdirectory
find "$input_dir/true_color" -type f -name "*.tif" | while read -r tif_file; do
