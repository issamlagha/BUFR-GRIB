...
OUTPUT_DIR = os.path.expanduser("/home/pnt/work/output/composites/dust")
COMPOSITES = ["dust"]  # Keep as list for loading multiple composites if needed
