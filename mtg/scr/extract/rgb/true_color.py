...
OUTPUT_DIR = os.path.expanduser("/home/pnt/work/output/composites/true_color")
COMPOSITES = ["true_color"]  # Keep as list for loading multiple composites if needed
...
def process_time_window(date_str, time_str, body_files):
    ...
    try:
        ...
        output_path = os.path.join(
            OUTPUT_DIR, 
            f"true-color_{date_str}-{time_str}.tif"
        )
